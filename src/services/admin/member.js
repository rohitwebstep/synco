...
// Create member
exports.createMember = async ({ firstName, lastName, email, bio, password, position, phoneNumber, roleId }) => {
    try {
        ...
        return {
            status: false,
            message: error?.parent?.sqlMessage || error?.message || "Failed to create member.",
        };
    }
};
...
exports.findMemberByEmail = async (email) => {
    try {
        ...
        return {
            status: false,
            message: error?.parent?.sqlMessage || error?.message || "Error occurred while finding member.",
        };
    }
};
...
exports.getMemberById = async (id) => {
    try {
        ...
        return {
            status: false,
            message: error?.parent?.sqlMessage || error?.message || "Error occurred while fetching member.",
        };
    }
};
...
exports.getAllMembers = async () => {
    try {
        ...
        return {
            status: false,
            message: error?.parent?.sqlMessage || error?.message || "Failed to fetch members.",
        };
    }
};
...
exports.updatePasswordById = async (id, newPassword) => {
    try {
        const result = await Member.update({ password: newPassword }, { where: { id } });
